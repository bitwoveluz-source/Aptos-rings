import { AccountInfo as ACAccountInfo, ExtendedNetwork, UserResponse as ACUserResponse } from '@aptos-connect/wallet-api';
...
export declare function networkToChainId(network: ExtendedNetwork): number | undefined;
